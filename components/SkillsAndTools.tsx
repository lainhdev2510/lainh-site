...
import ShowSkills from "./ui/ShowSkills";
  ...
  return (
    <section className="max-w-screen-md mx-auto my-10">
      ...
      <p className="mb-4 text-justify lg:leading-7 text-neutral-200 lg:text-start">
        A creative problem solver with over 2 years of programming experience,
        I&apos;ve explored diverse programming languages, libraries, and
        technology stacks, honing my skills in both Frontend, Backend, and App
        development.
      </p>
